...
<script>
import { getDictTypeList, getDictList, createDictType, createDict, updateDictType, updateDict, deleteDictType, deleteDict } from '@/api/dict' // eslint-disable-line
...
export default {
  components: { Pagination, Treeselect }, // eslint-disable-line
  data() {
    return {
  ...
  methods: {
    ...
    getList() {
      ...
      }).catch(error => { this.listLoading = false; console.log(error) })
    },
    getDictTypeList() {
